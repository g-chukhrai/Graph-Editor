...
**
** Created: Wed 28. Apr 09:37:43 2010
...
static const char qt_meta_stringdata_Viewer[] = {
    "Viewer\0\0finish(QList<QStringList>)\0,\0"
    "pathUpdate(QStringList,int)\0"
};

const QMetaObject Viewer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Viewer,
...
int Viewer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: finish((*reinterpret_cast< QList<QStringList>(*)>(_a[1]))); break;
        case 1: pathUpdate((*reinterpret_cast< QStringList(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        _id -= 2;
    }
...
// SIGNAL 0
void Viewer::finish(QList<QStringList> _t1)
{
...
// SIGNAL 1
void Viewer::pathUpdate(QStringList _t1, int _t2)
{
